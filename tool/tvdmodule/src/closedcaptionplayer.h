...
class ClosedCaptionPlayer : public pvr::CaptionPlayer {
public:
	ClosedCaptionPlayer( node::ObjectWrap *handle, bool isCC );
	virtual ~ClosedCaptionPlayer();

	virtual void enable( bool state );
	virtual void show( const std::string &data );

private:
	node::ObjectWrap *_handle;
	bool _isCC;
};
