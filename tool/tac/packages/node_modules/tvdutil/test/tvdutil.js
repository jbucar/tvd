...
describe('tvdutil', function() {
	...
	describe('fetchURL', function() {
		it('shoud fetch readme.txt', function(done) {
			let server = Mocks.createServer(__dirname);
			var options = {
				'url': 'http://127.0.0.1:8125/readme.txt',
				'fileOutput': '/tmp/readme.txt'
			};
			tvdutil.fetchURL( options, function(err) {
				assert.isUndefined( err );
				assert.isTrue( tvdutil.isFile( options.fileOutput ) );
				fs.unlinkSync( options.fileOutput );
				server.close(done);
			})
		});

		it('shoud fetch readme.txt showing progress bar', function(done) {
			let server = Mocks.createServer(__dirname);
			var last_progress = 0;
			var options = {
				'url': 'http://127.0.0.1:8125/readme.txt',
		...
		it('shoud fetch readme.txt and check md5', function(done) {
			let server = Mocks.createServer(__dirname);
			var options = {
				'url': 'http://127.0.0.1:8125/readme.txt',
				'fileOutput': '/tmp/readme.txt',
				'md5': '03e53356a62cf4bd85ce2e6156967ef1'
			};
			tvdutil.fetchURL( options, function(err) {
				assert.isUndefined( err );
				assert.isTrue( tvdutil.isFile( options.fileOutput ) );
		...
		it('shoud fetch readme.txt and check with invalid md5', function(done) {
			let server = Mocks.createServer(__dirname);
			var options = {
				'url': 'http://127.0.0.1:8125/readme.txt',
				'fileOutput': '/tmp/readme.txt',
				'md5': '03e53356a62cf4bd85ce2e6156967ef2'
			};
			tvdutil.fetchURL( options, function(err) {
				assert.isDefined( err );
		...
		it('shoud fetch readme.txt and check size', function(done) {
			let server = Mocks.createServer(__dirname);
			var options = {
				'url': 'http://127.0.0.1:8125/readme.txt',
				'fileOutput': '/tmp/readme.txt',
		...
		it('shoud fetch readme.txt and check with invalid size', function(done) {
			let server = Mocks.createServer(__dirname);
			var options = {
				'url': 'http://127.0.0.1:8125/readme.txt',
				'fileOutput': '/tmp/readme.txt',
		...
		it('shoud fetch readme.txt and check for enought space', function(done) {
			let server = Mocks.createServer(__dirname);
			var options = {
				'url': 'http://127.0.0.1:8125/readme.txt',
				'fileOutput': '/tmp/readme.txt',
		...
		it('shoud fetch readme.txt and check invalid output', function(done) {
			let server = Mocks.createServer(__dirname);
			var options = {
				'url': 'http://127.0.0.1:8125/readme.txt',
		...
		it('shoud not fetch invalid file', function(done) {
			let server = Mocks.createServer(__dirname);
			var options = {
				'url': 'http://127.0.0.1:8125/invalid_readme.txt',
		...
		xit('should fetch large file and validating progress', function(done) {
			this.timeout(20000);
			var last_progress = 0;
			var options = {
				'url': 'http://127.0.0.1:8125/large_file.txt',
		...
		it('should fetch using authentication readme.txt', function(done) {
			let user = 'pepe';
			let pass = 'pepe01';
			let server = Mocks.createServer(__dirname,user,pass);
			var options = {
				'url': 'http://127.0.0.1:8125/readme.txt',
				'user': user,
				'password': pass,
