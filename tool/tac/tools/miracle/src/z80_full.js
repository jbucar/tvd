...
const halfcarry_add_table = byteTable([ 0, 0x10, 0x10, 0x10, 0, 0, 0, 0x10 ]);
const halfcarry_sub_table = byteTable([ 0, 0, 0x10, 0, 0x10, 0, 0x10, 0x10 ]);
const overflow_add_table = byteTable([ 0, 0, 0, 0x04, 0x04, 0, 0, 0 ]);
const overflow_sub_table = byteTable([ 0, 0x04, 0, 0, 0, 0, 0x04, 0 ]);
