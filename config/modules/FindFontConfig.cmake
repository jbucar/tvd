...
#
include( ${DEPOT}/config/Utils.cmake )
...
FIND_LIBRARY(FONTCONFIG_LIBRARIES NAMES fontconfig ${FONTCONFIG_PKG_LIBRARY}
  PATHS
	$ENV{FONTCONFIG_DIR}
    /usr/local
    /usr/X11
...
# If static fontconfig is found, must add freetype, expat, iconv and bz2
IF("${FONTCONFIG_LIBRARIES}" MATCHES ".*\\.a$")
	MESSAGE(STATUS "Found STATIC FONTCONFIG")
	IF("${PLATFORM}" STREQUAL "SimIOS" OR "${PLATFORM}" STREQUAL "IOS")
		find_dependants(FONTCONFIG_LIBRARIES "freetype;expat")
		find_package(Bz2 REQUIRED)
		set(FONTCONFIG_LIBRARIES ${FONTCONFIG_LIBRARIES} ${BZ2_LIBRARIES})
	ELSEIF("${PLATFORM}" STREQUAL "UNIX" OR "${PLATFORM}" STREQUAL "ANDROID")
		find_dependants(FONTCONFIG_LIBRARIES "freetype;expat;iconv;bz2")
	ENDIF()
ENDIF("${FONTCONFIG_LIBRARIES}" MATCHES ".*\\.a$")
