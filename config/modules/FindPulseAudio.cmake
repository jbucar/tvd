...
if (PULSEAUDIO_FOUND)
   if (NOT PULSEAUDIO_FIND_QUIETLY)
      ...
      if (PULSEAUDIO_INCLUDE_DIR)
	   message(STATUS "Found PulseAudio headers: ${PULSEAUDIO_INCLUDE_DIR}")
      endif (PULSEAUDIO_INCLUDE_DIR)
...
find_package_handle_standard_args(PulseAudio DEFAULT_MSG PULSEAUDIO_LIBRARIES PULSEAUDIO_INCLUDE_DIR)
