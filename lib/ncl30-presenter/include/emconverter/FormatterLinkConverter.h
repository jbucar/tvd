...
/**
 * Se encarga de realizar todo el manejo relacionado con los links. Desde la creación de los mismos, hasta el manejo de las acciones o condiciones.
 */
...
public:
	...
	FormatterCausalLink* createCausalLink( CausalLink* ncmLink, CompositeExecutionObject* parentObject, int depthLevel );
