...
public:
	...
	ApplicationExecutionObject( string id, Node* node, GenericDescriptor* descriptor, bool handling );

	ApplicationExecutionObject( string id, Node* node, CascadingDescriptor* descriptor, bool handling );
