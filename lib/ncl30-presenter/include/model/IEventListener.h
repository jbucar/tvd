...
#define listenerType( listenerType ) \
	virtual const std::string type() const { return #listenerType; } \
...
public:
	...
	;
	virtual void eventStateChanged( void* event, short transition, short previousState )=0;
