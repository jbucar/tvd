...
public:
	SwitchEvent( const std::string &id, components::ExecutionObject* eObject, InterfacePoint* interfacePoint, int eventType, string key, ncl30presenter::event::EventManager *manager );

	listenerType( SwitchEvent );
	...
	virtual void eventStateChanged( void* event, short transition, short previousState );
