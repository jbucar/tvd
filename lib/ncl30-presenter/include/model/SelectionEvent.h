...
{
private:
	::util::key::type selectionCode;

public:
	SelectionEvent( const std::string &id, components::ExecutionObject* eObject, ContentAnchor* anchor, ncl30presenter::event::EventManager *manager );
	bool start();
	::util::key::type getSelectionCode();
