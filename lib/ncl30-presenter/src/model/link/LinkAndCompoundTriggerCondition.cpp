...
namespace model {
namespace link {
LinkAndCompoundTriggerCondition::LinkAndCompoundTriggerCondition(player::System *system) :
		LinkCompoundTriggerCondition(system) {
...
void LinkAndCompoundTriggerCondition::addCondition( LinkCondition* condition ) {
	...
	if (condition->instanceOf( "LinkTriggerCondition" )) {
		...
		LWARN("LinkAndCompoundTriggerCondition", "addCondition: statements trying to add a condition !instanceOf(LinkStatement) and !instanceOf(LinkTriggerCondition)");
	}
}

void LinkAndCompoundTriggerCondition::conditionSatisfied( void* condition ) {
