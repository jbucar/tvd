...
LinkAssignmentAction::LinkAssignmentAction( FormatterEvent* event, short actionType, string value, player::System *system ) :
	LinkRepeatAction( event, actionType, system ) {
