...
LinearTimeCostFunction::LinearTimeCostFunction( const std::string &id, double shrinkingFactor, double stretchingFactor, double shrinkingCost, double stretchingCost ) :
		TemporalFlexibilityFunction( id, shrinkingFactor, stretchingFactor ) {
