...
short EventUtil::getTypeCode( const std::string &typeName ) {
...
std::string EventUtil::getTypeName( short type ) {
	switch ( type ) {
...
short EventUtil::getStateCode( const std::string &stateName ) {
...
std::string EventUtil::getStateName( short state ) {
	switch ( state ) {
...
std::string EventUtil::getTransitionName( short transition ) {
	switch ( transition ) {
...
short EventUtil::getTransitionCode( const std::string &transition ) {
...
short EventUtil::getAttributeTypeCode( const std::string &attTypeName ) {
...
std::string EventUtil::getAttributeTypeName( short type ) {
	switch ( type ) {
