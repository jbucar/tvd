...
/**
 * Esta clase define una acción compuesta para realizar en un conector.
 * Se puede definir la forma de ejecutar las acciones, en paralelo o en orden secuencial.
 */
