...
public:
	Port( const std::string &id, bptnc::Node* someNode, InterfacePoint* someInterfacePoint );
	...
	bptnc::Node* getNode();
	virtual bptnc::Node* getEndNode();
	virtual InterfacePoint* getEndInterfacePoint();
	std::vector<bptnc::Node*>* getMapNodeNesting();
	void setInterfacePoint( InterfacePoint* someInterfacePoint );
	void setNode( bptnc::Node* someNode );
};
}
}
}
