...
public:
	...
	void *parseDescriptor( util::xml::dom::Node parentElement );
	virtual void *createDescriptor( util::xml::dom::Node parentElement )=0;

	virtual void addDescriptorParamToDescriptor( void *parentObject, void *childObject )=0;

	void *parseDescriptorBase( util::xml::dom::Node parentElement );

	virtual void *createDescriptorBase( util::xml::dom::Node parentElement )=0;
	...
	void *parseDescriptorBind( util::xml::dom::Node parentElement );

	virtual void *createDescriptorBind( util::xml::dom::Node parentElement )=0;

	void *parseDescriptorParam( util::xml::dom::Node parentElement );

	virtual void *createDescriptorParam( util::xml::dom::Node parentElement )=0;
