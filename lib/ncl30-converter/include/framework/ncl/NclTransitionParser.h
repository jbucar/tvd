...
public:
	...
	void *parseTransitionBase( util::xml::dom::Node parentElement );

	virtual void* createTransitionBase( util::xml::dom::Node parentElement )=0;
	...
	void* parseTransition( util::xml::dom::Node parentElement );

	virtual void* createTransition( util::xml::dom::Node parentElement )=0;
