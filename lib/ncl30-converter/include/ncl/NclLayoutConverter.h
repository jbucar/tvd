 ...
 * Por medio de llamadas de @c NclLayoutParser se va armando el modelo.
 */
...
public:
	...
	void *createRegionBase( util::xml::dom::Node parentElement );
	void *createRegion( util::xml::dom::Node parentElement, void* parent );
