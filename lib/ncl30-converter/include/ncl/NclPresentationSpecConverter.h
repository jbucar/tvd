...
public:
	...
	void *createDescriptorParam( util::xml::dom::Node parentElement );

	void *createDescriptorBind( util::xml::dom::Node parentElement );

	void *createDescriptorBase( util::xml::dom::Node parentElement );

	void *createDescriptor( util::xml::dom::Node parentElement );
