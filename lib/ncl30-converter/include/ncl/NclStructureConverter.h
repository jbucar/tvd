 ...
 * Por medio de llamadas de @c NclStructureParser se va armando el modelo.
 */
...
public:
	...
	virtual void *createBody( util::xml::dom::Node parentElement );
...
public:
	...
	virtual void* createHead( util::xml::dom::Node parentElement );

	virtual void* createNcl( util::xml::dom::Node parentElement );
