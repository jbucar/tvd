...
public:
	...
	// Font methods
	virtual void addFontDirectory( const std::string &dir );
	virtual void clearFontDirectories();

	virtual std::string name();

	QFontDatabase *fontsDB() const;
...
protected:
	...
	void addImpl( const std::string &dir, int maxDepth );
